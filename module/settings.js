export function registerTorgSettings() {
    ...
    game.settings.register("torgeternity", "playersSeeThreatCards", {
        // game.setting.register("NameOfTheModule", "VariableName",
        name: "allow players to see threat cards", // Register a module setting with checkbox
        hint: "If checked, the players can see threat cards by click Control and hovering threat token", // Description of the settings
